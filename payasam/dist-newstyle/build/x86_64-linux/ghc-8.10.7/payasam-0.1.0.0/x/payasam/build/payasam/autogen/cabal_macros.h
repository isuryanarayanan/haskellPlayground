...
/* package payasam-0.1.0.0 */
#ifndef VERSION_payasam
#define VERSION_payasam "0.1.0.0"
#endif /* VERSION_payasam */
#ifndef MIN_VERSION_payasam
#define MIN_VERSION_payasam(major1,major2,minor) (\
  (major1) <  0 || \
  (major1) == 0 && (major2) <  1 || \
  (major1) == 0 && (major2) == 1 && (minor) <= 0)
#endif /* MIN_VERSION_payasam */
...
#define CURRENT_COMPONENT_ID "payasam-0.1.0.0-inplace-payasam"
